  ...
  return (
    <div className='pb-10'>
     ...
     transition={{duration:1.5}}
      className='text-center mb-10 text-3xl lg:text-4xl'>Technologies</motion.h2>
      <motion.div 
      ...
      transition={{duration:1.5}}
       className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-10">
        {technologies.map((tech, index) => (
          <div
            key={index}
            className='border cursor-pointer border-white rounded-full px-6 py-2 flex items-center gap-2 bg-black'
          >
            <div
